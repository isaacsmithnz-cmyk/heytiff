...
- **A card's identity is one stack down the left:** the name, then what it is, then whose it is — three lines that shorten together on one edge, which leaves the top right for the cross. The header's button says Add; the title beside it already says what.
