...
- **Delete system is on the card too,** under Edit system and quieter than it, so a system can go without opening its builder. It is labelled, never a cross: a chip's cross clears one zone, and this takes a whole system and its units off the plan. Its zones go back to unclaimed and it costs one undo, the same as the builder's.
