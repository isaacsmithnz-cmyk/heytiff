...
- **Add zone is not wired into the system.** It sits last in the grid so it reads as the next card along, but it is a control, not a zone: the trunk ran into it and drew the system as serving a button.
