    ...
    <div className="ds-home">
      ...
      >
        ...
        <path
          ...
          style={{ ["--d" as never]: "0s" }}
          pathLength={1}
          d="M-20 150 H240 V70 H470 V180 H720 V80 H980 V210 H1220"
        />
        <path
          className="dp"
          style={{ ["--d" as never]: "1.2s" }}
          pathLength={1}
          d="M-20 400 H210 V320 H460 V470 H710 V360 H960 V500 H1220"
        />
        <path
          className="dp"
          style={{ ["--d" as never]: "2.2s" }}
          pathLength={1}
          d="M-20 650 H300 V560 H540 V700 H820 V600 H1080 V690 H1220"
        />
        <path
          className="dp"
          style={{ ["--d" as never]: "3s" }}
        ...
        <path
          className="dp"
          style={{ ["--d" as never]: "3.8s" }}
          pathLength={1}
          d="M540 700 V780"
        />
        <circle
          className="pdot"
          style={{ ["--d" as never]: "2.6s" }}
          cx="470"
          cy="70"
          r={6}
        />
