...
const BASE = [
  ...
  "",
  "FORMATTING: short paragraphs, and simple bullet lines beginning '- ' where a",
  "list is genuinely the shape of the answer. Nothing else — no headings, no",
  "tables, no code fences, no bold or italic markers, no numbered lists. The",
  "screen renders paragraphs and bullets and nothing more, so any other markup",
  "arrives as literal characters in front of the reader. Fault codes and model",
  "numbers are written as ordinary words in a sentence.",
].join("\n");
