...
function systemPrompt(ctx: NoteContext): string {
  ...
  return [
    ...
    "  Written in the note's OWN words: it is shown back to the author as",
    "  their note. Never put your commentary about the note or the recording",
    "  there ('trails off mid-sentence', 'may be missing detail') — if",
    "  something genuinely blocks routing, that is what clarify is for.",
    "",
